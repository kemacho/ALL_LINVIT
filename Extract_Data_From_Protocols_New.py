...
def process_files(action):
    ...
    for i, file_path in enumerate(file_paths):
        try:
            ...
            if 'Тип СИ' in Check5:
                if sheet2 is not None:
                    cell_value2 = sheet2['AG36'].value  # Тип СИ ПКЭ
                    cell_value1 = sheet2['BE36'].value  # Заводской номер СИ ПКЭ
                    cell_value14 = sheet2['CD36'].value  # Поверка СИ ПКЭ

                    cell_value10 = sheet2['AG37'].value  # Тип СИ
                    cell_value11 = sheet2['BE37'].value  # Заводской номер СИ
                    cell_value15 = sheet2['CD37'].value  # Поверка СИ

                    cell_value25 = sheet2['A8'].value
                    cell_value26 = sheet2['A9'].value
                    cell_value27 = sheet2['A24'].value

                    cell_value5 = format_date(sheet2['M27'].value)  # Начало испытаний
                    cell_value6 = format_date(sheet2['M28'].value)  # Окончание испытаний

                if sheet1 is not None:
                    cell_value4 = sheet1['A31'].value  # Электрические сети
                    cell_value4_1 = sheet1['A32'].value  # Электрические сети
                    cell_value9 = sheet1['BC25'].value  # Номер протокола
                    cell_value12 = format_date(sheet1['BU20'].value)  # Дата протокола
                ...
                if sheet3 is not None:
                    cell_value8 = sheet3['AK7'].value  # Место в схеме
                    cell_value13 = sheet3['U10'].value  # Центр питания
                    cell_value24 = sheet3['BZ38'].value  # Эксперт протокол
